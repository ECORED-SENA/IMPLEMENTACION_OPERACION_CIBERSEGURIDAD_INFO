    ...
    .container.tarjeta.p-4.p-sm-5(
      ...
      .row.justify-content-around.align-items-center
          ...
          .banner-principal__datos
            ul
              li.mb-3.banner-principal__datos__item
                ...
                p.banner-principal__datos__item__texto Implementación y operación de la ciberseguridad
              li.mb-3.banner-principal__datos__item
        ...
        .d-none.d-lg-block.col-lg-5
          ...
          .video
            | <iframe data-v-1f9e4816="" width="560" height="315" src="https://www.youtube.com/embed/ulnGV4p_sq8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen"></iframe>
